                    ...
                    <form action="{{ route('transacoes.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="valor" class="mt-1 block w-full focus:border-gray-500 focus:ring-gray-500" type="number" name="valor" :value="old('valor')" step="0.01" required />
                            </div>

                            <div>
                                <x-input-label for="data" :value="__('Data')" />
                                <x-text-input id="data" class="mt-1 block w-full focus:border-gray-500 focus:ring-gray-500" type="date" name="data" :value="old('data', date('Y-m-d'))" required />
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="descricao" class="mt-1 block w-full focus:border-gray-500 focus:ring-gray-500" type="text" name="descricao" :value="old('descricao')" placeholder="Ex: Supermercado, Salário..." />
                            </div>
